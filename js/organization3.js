...
function nodeTemplate(optopns) {
    // let areaControl = '';
    // let departmentIcon = '';
    // let bottomPanel = '';
    // if (optopns.areaUrl !== null) {
    //     areaControl = `<div class="areaUrl" data-url="${optopns.areaUrl}" data-bs-toggle="modal" data-bs-target="#floorPlan">${optopns.area}</div>`;
    // } else {
    //     areaControl = optopns.area;
    // }
    // if (!optopns.isLast) {
    //     departmentIcon = `<span class="col-2 icon" data-bs-toggle="modal" data-bs-target="#exampleModal${optopns.id}"><i class="far fa-id-card"></i></span>`;
    // }
    // if (!optopns.isLast) {
    //     // if (!isRoot) {
    //     //     bottomPanel += `<div class="more"><i class="fas fa-minus"></i></div>`;
    //     // }
    //     bottomPanel += `
    //     <div class="col">
    //         <p class="count d-flex justify-content-between"><i class="fas fa-user">&nbsp;${optopns.count} </i>
    //         </p>
    //     </div>
    //     `;
    // }
    return `
        <div class="header">
            <span class="col-10 dept">${optopns.dept}</span>
        ...
        <div class="row align-items-center">
            <div class="col-lg-4 col-12">
                <div class="pic">
                    <img src="../public/img/organization/${optopns.pic}">
                </div>
            </div>
            <div class="col-lg-8 col-12 px-3 py-1 text-left">
                <p class="position">${optopns.position}</p>
                <p class="name">${optopns.chName} &nbsp; <span class="name">${optopns.name}</span></p>
                <p class="name text-black-50">${optopns.num}</p>
            </div>
        </div>
        <div class="row justify-content-between align-items-center px-1">
            <div class="col-5">
                <p>${optopns.tel}</p>
                <p>分機<span>${optopns.ext}</span></p>
            </div>
...
const orgRender = $("#chart-container").orgchart({
    ...
    // createNode: function ($node, optopns) {
    //     $node.find(".fa-id-card").on('click', function () {
    //         const Area = $('#modalArea')
    //         if (!optopns.isLast) {
    //             $(`<div class="modal fade" id="exampleModal${optopns.id}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    //                 <div class="modal-dialog">
    //                     <div class="modal-content">
    //                     <div class="modal-header">
    //                         <h5 class="modal-title" id="exampleModalLabel">${optopns.dept}</h5>
...
function showAll() {
    ...
    if ($temp.hasClass('hidden')) {
        console.log($temp.hasClass('hidden'));
        $temp[0].offsetWidth;
...
function scrollbarOffset() {
    ...
    // const innerOffset = inner.getBoundingClientRect();
    // const levelOffset = level.getBoundingClientRect();
    // console.log(innerOffset.left);
    // console.log(levelOffset.left);
    // const minusOffset = (innerOffset.left - levelOffset.left)
    // const scrollbarOffset = (document.body.clientWidth) - (minusOffset)
    // $(window).scrollLeft(scrollbarOffset)
    // console.log("$container[0].offsetLeft",$container[0].offsetLeft);
    // console.log(e.target.offsetWidth);
    console.log("Item offsetLeft",$("#sidebar-wrapper")[0].clientWidth);
    console.log("document.body.clientWidth", document.body.clientWidth);
    const ItemoffsetWidth = $("#sidebar-wrapper")[0].clientWidth;
    const windowClientWidth = document.body.clientWidth;
    const scrollbarOffset = (windowClientWidth) - (ItemoffsetWidth)
    $(window).scrollLeft(ItemoffsetWidth)
}
