...
DataTable.ext.buttons.excelHtml5 = {
	...
	action: function ( e, dt, button, config ) {
        ...
        // add by shf 2017/8/23
        /*---*/
        //var mergeCellsCol = function( col, rowspan) {
        //    var mergeCells = $('mergeCells', rels);
        //    mergeCells.append( '<mergeCell ref="A'+col+':'+createCellPos(rowspan)+col+'" />' );
        //    mergeCells.attr( 'count', mergeCells.attr( 'count' )+1 );
        //    $('col:eq('+(col-1)+') c', rels).attr( 's', '51' ); // centre
        //};
        /*---*/
